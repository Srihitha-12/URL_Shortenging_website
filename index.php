...
<body>
	<div class="main-class">
		...
		<form >
			...
			<input type=text name="full_url"  placeholder="Enter the url" required/>
			<button onClick="shortenBtnCLicked()">Shortern URL</button>
		</form>
		<?php 
			include "PHPScripts/config.php";
			$sql2 = mysqli_query($conn , "select * from url ");
		...
		?>
			<div class="click-count-class">
				...
				?>
			<span style="color:green;">Total Links: <span> <?php echo $links ?></span> & Total Clicks: <span> <?php echo $clicks ?> </span></span>
